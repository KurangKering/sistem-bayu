class ContextNew(object):
    ...
    def add_guess_word(self,word):
        self.guess_words.append(word)
    ...
    def init_visitors(self):
        ...
        self.infix_visitors = self.visitor_provider.get_infix_visitors()
    ...
    def remove_prefixes(self):
        self.accept_visitors(self.prefix_visitors)
        if self.dictionary.contains(self.current_word):
            return
    ...
    def remove_infixes(self):
        self.accept_visitors(self.infix_visitors)
